 ...
 *
 * @extends 	Walker
 * @class 		WC_Product_Brand_Dropdown_Walker
 * @version		1.6.4
...
class WC_Product_Brand_List_Walker extends Walker {
	...
	function start_el( &$output, $brand, $depth = 0, $args = array(), $current_object_id = 0 ) {
		...
		$output .= '<li class="cat-item cat-item-' . $brand->term_id;
		...
		$output .=  '"><a href="' . get_term_link( (int) $brand->term_id, 'product_brand' ) . '">' . __( $brand->name, 'woocommerce' ) . '</a>';
	 ...
	 * @param int $depth Depth of brand. Not used.
	 * @param array $args Only uses 'list' for whether should append to output.
	 */
	function end_el( &$output, $brand, $depth = 0, $args = array() ) {
